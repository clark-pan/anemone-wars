...
(function(process) {
        ...
        var b = 1,
            _ = {
              ...
              _processPendingState: function(e, t) {
                ...
                if (o && 1 === r.length)
                  return r[0];
                for (var i = a({}, o ? r[0] : n.state),
                    s = o ? 1 : 0; s < r.length; s++) {
                  var u = r[s];
        ...
        function s() {
          ...
          switch (t ? void 0 : I(!1), e._tag) {
            ...
            case "audio":
              ...
              for (var n in H)
                H.hasOwnProperty(n) && e._wrapperState.listeners.push(E.trapBubbledEvent(C.topLevelTypes[n], H[n], t));
              break;
            case "img":
      ...
      49: [function(e, t, n) {
        ...
        function o(e) {
          ...
          if ("radio" === t.type && null != o) {
            for (var i = u.getNodeFromInstance(this),
                a = i; a.parentNode; )
              a = a.parentNode;
            for (var p = a.querySelectorAll("input[name=" + JSON.stringify("" + o) + '][type="radio"]'),
                d = 0; d < p.length; d++) {
              var f = p[d];
 ...
 while (o);
      ...
      149: [function(e, t, n) {
        ...
        function s(e, t, n, r) {
          var i = typeof e;
          if ("undefined" !== i && "boolean" !== i || (e = null), null === e || "string" === i || "number" === i || l.isValidElement(e))
            ...
            if (y) {
              ...
              if (y !== e.entries)
                for (var _ = 0; !(C = b.next()).done; )
                  u = C.value, h = m + o(u, _++), v += s(u, h, n, r);
              else
                for (; !(C = b.next()).done; ) {
                  var E = C.value;
