...
(function(Buffer, process) {
  (function(mod) {
    if (typeof exports == "object" && typeof module == "object")
      mod(require('../lib/codemirror'), require('../addon/search/searchcursor'), require('../addon/dialog/dialog'), require('../addon/edit/matchbrackets'));
    ...
    var Vim = function() {
      ...
      var commandDispatcher = {
        ...
        processSearch: function(cm, vim, command) {
          ...
          function onPromptKeyUp(e, query, close) {
            ...
            var parsedQuery;
            try {
              parsedQuery = updateSearchQuery(cm, query, true, true);
            } catch (e) {}
            if (parsedQuery) {
      ...
      var motions = {
        ...
        textObjectManipulation: function(cm, head, motionArgs, vim) {
          ...
          if (mirroredPairs[character]) {
            ...
            tmp = expandWordUnderCursor(cm, inclusive, true, true);
          } else if (character === 'w') {
            tmp = expandWordUnderCursor(cm, inclusive, true, false);
          } else if (character === 'p') {
      ...
      function makePrompt(prefix, desc) {
        ...
        raw += '<input type="text"/> ' + '<span style="color: #888">';
        if (desc) {
