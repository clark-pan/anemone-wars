...
var Checkbox = function(_React$Component) {
  ...
  _createClass(Checkbox, [{
    ...
    value: function componentWillReceiveProps(nextProps) {
      this.setState({switched: this.props.checked !== nextProps.checked ? nextProps.checked : this.state.switched});
    }
  }, {
    key: 'isChecked',
...
Checkbox.contextTypes = {muiTheme: _react2.default.PropTypes.object.isRequired};
