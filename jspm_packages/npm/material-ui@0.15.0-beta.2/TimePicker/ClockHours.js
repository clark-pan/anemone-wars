...
var ClockHours = function(_React$Component) {
  _inherits(ClockHours, _React$Component);
  function ClockHours() {
...
ClockHours.contextTypes = {muiTheme: _react2.default.PropTypes.object.isRequired};
