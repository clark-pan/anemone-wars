...
var ClockPointer = function(_React$Component) {
  ...
  function ClockPointer() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(ClockPointer)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {inner: (0, _timeUtils.isInner)(_this.props)}, _temp), _possibleConstructorReturn(_this, _ret);
  }
...
ClockPointer.contextTypes = {muiTheme: _react2.default.PropTypes.object.isRequired};
