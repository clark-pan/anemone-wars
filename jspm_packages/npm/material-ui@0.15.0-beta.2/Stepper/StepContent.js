...
(function(process) {
  ...
  var StepContent = function(_React$Component) {
    _inherits(StepContent, _React$Component);
    ...
    _createClass(StepContent, [{
      ...
      value: function render() {
        ...
        return _react2.default.createElement('div', _extends({style: prepareStyles((0, _simpleAssign2.default)(styles.root, style))}, other), _react2.default.createElement(_ExpandTransition2.default, {
          enterDelay: 450,
          open: active
        }, _react2.default.createElement('div', {style: {overflow: 'hidden'}}, children)));
      }
    }]);
    return StepContent;
