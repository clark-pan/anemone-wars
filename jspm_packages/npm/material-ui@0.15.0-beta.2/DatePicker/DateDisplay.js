...
function getStyles(props, context, state) {
  ...
  var styles = {
    ...
    monthDayTitle: {cursor: !selectedYear ? 'default' : 'pointer'},
    year: {
      margin: 0,
      fontSize: 16,
      fontWeight: '400',
    ...
    yearTitle: {cursor: !selectedYear && !props.disableYearSelection ? 'pointer' : 'default'}
  };
  return styles;
}
var DateDisplay = function(_React$Component) {
  ...
  _createClass(DateDisplay, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({}, other, {style: prepareStyles((0, _simpleAssign2.default)(styles.root, style))}), _react2.default.createElement(_SlideIn2.default, {
        style: styles.year,
...
DateDisplay.contextTypes = {muiTheme: _react2.default.PropTypes.object.isRequired};
