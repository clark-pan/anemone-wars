...
var DatePickerInline = function(_React$Component) {
  ...
  function DatePickerInline() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(DatePickerInline)).call.apply(_Object$getPrototypeO, [this].concat(args))), _this), _this.state = {anchorEl: null}, _temp), _possibleConstructorReturn(_this, _ret);
  }
  _createClass(DatePickerInline, [{
    key: 'componentWillReceiveProps',
    value: function componentWillReceiveProps(nextProps) {
      if (nextProps.open) {
        this.setState({anchorEl: this.refs.root});
      }
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      }, children, _react2.default.createElement('div', {style: styles.actions}, actions)));
    }
  }]);
...
DatePickerInline.defaultProps = {open: false};
