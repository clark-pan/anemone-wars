...
var verbose = false;
vows.describe('Flat list of strings: ["Apple", "Orange", "Banana"]').addBatch({'Flat:': {
    topic: function() {
      var fruits = ['Apple', 'Orange', 'Banana'];
      var fuse = new Fuse(fruits, {verbose: verbose});
      return fuse;
    },
...
vows.describe('List of books - searching "title" and "author"').addBatch({'Books:': {
    topic: function() {
      var books = require('./books.json!systemjs-json');
      var options = {
        keys: ['title', 'author'],
        verbose: verbose,
        tokenize: true
...
vows.describe('Deep key search, with ["title", "author.firstName"]').addBatch({'Deep:': {
    topic: function() {
      var books = [{
        'title': "Old Man's War",
        'author': {
...
vows.describe('Custom search function, with ["title", "author.firstName"]').addBatch({'Deep:': {
    topic: function() {
      var books = [{
        'title': "Old Man's War",
        'author': {
...
vows.describe('Include score in result list: ["Apple", "Orange", "Banana"]').addBatch({'Options:': {
    topic: function() {
      var fruits = ['Apple', 'Orange', 'Banana'];
...
vows.describe('Only include ID in results list, with "ISBN"').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': '0765348276',
        'title': "Old Man's War",
...
vows.describe('Include both ID and score in results list').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': '0765348276',
        'title': "Old Man's War",
...
vows.describe('Search when IDs are numbers').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': 1111,
        'title': "Old Man's War",
...
vows.describe('Recurse into arrays').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': '0765348276',
        'title': "Old Man's War",
...
vows.describe('Recurse into objects in arrays').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': '0765348276',
        'title': "Old Man's War",
...
vows.describe('Searching by ID').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': 'A',
        'title': "Old Man's War",
...
vows.describe('Set new list on Fuse').addBatch({'Options:': {
    topic: function() {
      var fruits = ['Apple', 'Orange', 'Banana'];
...
vows.describe('Searching by nested ID').addBatch({'Options:': {
    topic: function() {
      var books = [{
        'ISBN': {'name': 'A'},
        'title': "Old Man's War",
...
vows.describe('Searching list').addBatch({'Options:': {
    topic: function() {
...
vows.describe('Searching list').addBatch({'Options:': {
    topic: function() {
      var items = ['Borwaila hamlet', 'Bobe hamlet', 'Bo hamlet', 'Boma hamlet'];
      var fuse = new Fuse(items, {
        include: ['score'],
        verbose: verbose
      });
...
vows.describe('List of books - searching for long pattern length > 32').addBatch({'Books:': {
    topic: function() {
      var books = require('./books.json!systemjs-json');
      var options = {
        keys: ['title'],
...
vows.describe('Weighted search').addBatch({'Books:': {
    topic: function() {
      var items = [{
...
vows.describe('Search location').addBatch({'Books:': {
    topic: function() {
      var items = [{name: 'Hello World'}];
      var options = {
        keys: ['name'],
        verbose: verbose,
