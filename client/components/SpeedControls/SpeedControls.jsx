...
export default class SpeedControls extends Component {
	render() {
		...
		if (this.props.isPlaying) {
			playOrPauseBtn = <mui.IconButton onTouchTap={() => this.props.onPlayStateChange(false)} iconClassName="material-icons icon-size-m" style={btnStyle}>pause_arrow</mui.IconButton>;
		} else {
			playOrPauseBtn = <mui.IconButton onTouchTap={() => this.props.onPlayStateChange(true)} iconClassName="material-icons icon-size-m" style={btnStyle}>play_arrow</mui.IconButton>;
		}
